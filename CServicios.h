...
int CVV;
public:
Servicios(int num_tarjeta, int año_venci, int mes_venci, int CVV){this->num_tarjeta=num_tarjeta; this->año_venci=año_venci; this->mes_venci=mes_venci; this->CVV=CVV;}
